...
public class ResonantCollinearityPt1 {
                        ...
                        for (int l = 0; l < coordPairs.size(); ++l) {
                            if (k != l) {
                                ...
                                if (coordPairs.get(k).get(0) <= coordPairs.get(l).get(0) && 
                                    ...
                                    if ((coordPairs.get(k).get(0) - vertDist) >= 0 && 
                                        (coordPairs.get(k).get(1) - horiDist) >= 0) {
                                        antinodes.get(coordPairs.get(k).get(0) - vertDist).set(coordPairs.get(k).get(1) - horiDist, '#');
                                    }

                                    if ((coordPairs.get(l).get(0) + vertDist) <= (antinodes.size() - 1) && 
                                        (coordPairs.get(l).get(1) + horiDist) <= (antinodes.get(0).size() - 1)) {
                                        antinodes.get(coordPairs.get(l).get(0) + vertDist).set(coordPairs.get(l).get(1) + horiDist, '#');
                                    }
                                }
                                else if (coordPairs.get(k).get(0) >= coordPairs.get(l).get(0) && 
                                    coordPairs.get(k).get(1) >= coordPairs.get(l).get(1)) {
                                
                                    if ((coordPairs.get(k).get(0) + vertDist) <= (antinodes.size() - 1) && 
                                        (coordPairs.get(k).get(1) + horiDist) <= (antinodes.get(0).size() - 1)) {
                                        antinodes.get(coordPairs.get(k).get(0) + vertDist).set(coordPairs.get(k).get(1) + horiDist, '#');
                                    }

                                    if ((coordPairs.get(l).get(0) - vertDist) >= 0 && 
                                        (coordPairs.get(l).get(1) - horiDist) >= 0) {
                                        antinodes.get(coordPairs.get(l).get(0) - vertDist).set(coordPairs.get(l).get(1) - horiDist, '#');
                                    }
                                }
                                else if (coordPairs.get(k).get(0) >= coordPairs.get(l).get(0) && 
