        ...
        for (int i = 0; i < regions.size(); ++i) {
            for (int j = 0; j < regions.get(0).size(); ++j) {
                if (visited.get(i).get(j) == 0) {
                            ...
                            if (localVisited.get(k).get(l) == 1) {
                                ...
                                if (k - 1 >= 0) {
                                    ...
                                    if (l - 1 >= 0) {
                                        ...
                                        else if (localVisited.get(k - 1).get(l) == 0 &&
                                            localVisited.get(k - 1).get(l - 1) == 1) {
                                            regionSides += 2;
                                        }
                                    }
                                    else {
                    ...
                    for (int k = localVisited.size() - 1; k >= 0; --k) {
                        for (int l = localVisited.get(0).size() - 1; l >= 0; --l) {
