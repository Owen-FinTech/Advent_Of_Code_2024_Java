...
public class RestroomRedoubtPt1 {
    ...
    public static int safetyFactor(ArrayList<ArrayList<Integer>> posVel, int width, int height) {
            ...
            for (int k = 0; k < map.get(j).size(); ++k) {
                for (int l = 0; l < map.get(j).get(k).size(); ++l) {
                    if (map.get(j).get(k).get(l) != -1 ) {
                        ...
                        if (k < (width / 2) && j < (height / 2)) {
                            topRight += 1;
                        }
                        else if (k > (width / 2) && j < (height / 2)) {
                            topLeft += 1;
                        }
                        else if (k < (width / 2) && j > (height / 2)) {
                            botRight += 1;
    ...
    public static void main(String[] args) {
        ...
        System.out.println(safetyFactor(posVel, 101, 103));
    }
